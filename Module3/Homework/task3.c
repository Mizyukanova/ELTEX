/* Задание: написать программу, осуществляющую однонаправленную связь через pipe 
между процессом-родителем и процессом-ребенком, исполняющих разные программы. */
