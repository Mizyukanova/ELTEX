/* Программа 2 для иллюстрации некорректности работы с разделяемой памятью */

 

/* Мы организуем разделяемую память для массива из 3-х целых чисел. 
...
Для синхронизации используются семафоры. */
...
printf("Program1 was spawn %d times, program2 - %d times, total - %d times\n",
